...
def main():
    ...
    def menu1():
        ...
        if choice=="Introduction":
            ...
            st.markdown(''' Un éveil en faveur de la transition écologique globale qui s'est opéré en moi  le 6 Novembre 2017 parmi les 16000 participants à la Conférence des Parties à Bonn en Allemenage.Suite à une prise de conscience des enjeux environnementaux et sociétaux auxquels notre planète est confrontée,l'idée de créer un cabinet de conseil d'ingénierie pour la transition écologique globale a commencé à faire chemein dans ma tete .Ensuite  mes 5 ans de formation continue en informatique va me persuader du fait que l'accéleration du processus de transition ecologique globale sera tributaire de la transformation digitale des secteurs impliqués dans l'émission des gaz à effet de serre.''')
