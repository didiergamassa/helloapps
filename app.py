...
def main():
    ...
    if choice=="Introduction":
       st.markdown(''' ## Conception d'un Cabinet de Conseil Français Axé sur la Stratégie de Gestion Data, Énergie, Environnement et Maintenance pour la Transition Écologique Globale! ''') 
...
''') 
       st.markdown(f"<u><h4><b> Evaluation des problématiques de consommation d'énergie des batiments tertiaires en France: </u></h4></b>", unsafe_allow_html=True)
