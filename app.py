...
def main():
    ...
    def menu1():
        ...
        if choice=="Introduction":
            ...
            st.markdown(''' Délégué de l'ONG APEGG du Congo,mon éveil en faveur de la transition écologique globale s'est manifesté  le 6 Novembre 2017 parmi les 16028 participants à la Conférence de la Terre(dit des Parties)  à Bonn en Allemenage.A partir d'une prise de conscience des enjeux environnementaux et sociétaux auxquels notre planète est confrontée,l'idée de créer un cabinet de conseil d'ingénierie pour la transition écologique globale a commencé à faire chemein dans ma tete .Ensuite  mes 5 ans de formation continue en informatique vont  me convaincre du fait que l'accéleration du processus de transition ecologique globale sera tributaire de la transformation digitale des secteurs impliqués dans l'émission des gaz à effet de serre.''')
            url35="https://www.unfccc.int/sites/default/files/resource/inf04_0.pdf"
            st.markdown(f'<a href="{url35}" target="_blank">{"Cliquez ici pour visiter"+"www.mon éveil à Bonn.Allemagne2017"}</a>', unsafe_allow_html=True)
