...
''') 
       ...
       st.markdown(''' ###### 4.Axe sanitaire: Une étroite collaboration sera entretenu avec des conseillers sanitaires issus du réseau médical du feu Docteur Alain Pensé Gamassa constitué de près de 500 Medecins ''')  
       st.markdown(f"<u><h4><b> Stratégie de developpement commercial à court terme: </u></h4></b>", unsafe_allow_html=True)
