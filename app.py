...
def main():
    ...
    if choice=="Introduction":
       ...
       st.markdown(''' ###### 4.Axe sanitaire: Une étroite collaboration sera entretenu avec des conseillers sanitaires issus du réseau médical du feu Docteur Alain Pensé Gamassa constitué de près de 500 Medecins.A noter que la COVID ,avec l'aide des experts sanitaires ,a réglementé  la manière dont l'air est diffusé  dans les batiments tertiaires.En effet présence obligatoire des detecteurs de CO2 afin de surveiller la qualité de l'air avec un objectif de concentration en CO2 de 1000ppm en temps normal et 800 ppm pour la pandémie de covid-19''')  
