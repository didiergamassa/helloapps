...
''') 
       ...
       st.markdown(f"<u><h4><b> Solutions de reduction des émissions des gaz à effet de serre liés aux consommations d'énergie dans le secteur de l'immobilier tertiaire: </u></h4></b>", unsafe_allow_html=True)
