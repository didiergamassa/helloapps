...
def main():
    ...
    if choice=="Introduction":
       ...
       st.markdown(''' ###### 4.Axe sanitaire: Une étroite collaboration sera entretenu avec des conseillers sanitaires issus du réseau médical du feu Docteur Alain Pensé Gamassa constitué de près de 500 Medecins.A savoir que la COVID a réglementé la manière dont l'air est diffusé  dans les batiments tertiaires''')  
