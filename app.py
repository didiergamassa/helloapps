...
def main():
    ...
    if choice=="Introduction":
       ...
       st.markdown(''' ###### 4.Axe sanitaire: Une étroite collaboration sera entretenu avec des conseillers sanitaires issus du réseau médical du feu Docteur Alain Pensé Gamassa constitué de près de 500 Medecins.A noter que la COVID ,avec l'aide des experts sanitaires ,a réglementé en France la manière dont l'air est diffusé  dans les batiments tertiaires''')  
