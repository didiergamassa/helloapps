...
''')            
    ...
    menu_selection = st.sidebar.radio("Sélectionnez une option",("0_Perspectives_du_Cabinet_APEGG","1_Etude de faisabilité","2_Fournisseurs_Réseau_LoRaWan","3_Fournisseurs_Instruments_IoT_Lora ","4_Budget","5_Cahier des Charges _SaaS","6_Architecture_Réseau","7_Environnement_Test|Production","8_Environnement_Deploiement","9_Et_Quel_Avenir_dans_5ans?"))
    ...
    if menu_selection == "0_Perspectives_du_Cabinet_APEGG":
        ...
        menu2()
    elif menu_selection == "3_Fournisseurs_Instruments_IoT_Lora ":
        menu3()    
