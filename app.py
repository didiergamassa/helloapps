...
def main():
    ...
    def menu1():
        ...
        if choice=="Introduction":
            ...
            st.markdown('''###### Projet laissé en jachère  par le Docteur Alain Pensé GAMASSA qui n'est plus de ce monde mais tenait à transmettre le témoin de son engagement écologique en faveur de la protection de notre planète à l'un de ses proches. En 2017, son ONG, engagée dans la lutte contre les changements climatiques, va déléguer Landry Didier GAMASSA comme réprésentant à la Conférence des Parties(dit aussi Conférence de la Terre) qui se tenait du 6 au 17 Novembre 2017 à Bonn en Allemagne.16028 participants composés des délégués d'ONG,scientifiques,décideurs économiques et leaders politiques du monde y étaient conviés pour débattre sur les moyens de lutte contre les  changements climatiques.Il était apparu que la trajectoire de maintien du rechauffement de la planète à 1.5°C par rapport l'ére pré-industrielle, convenue à la conférence du climat de Paris ,présentait des écarts qui exigeaient des mesures contraignantes envers les pays les plus pollueurs de notre planète.Cette Conférence organisée sous l'initiative du PNUE (Programme des Nations Unies pour l’Environnement) étayait encore une fois la gravité des dégats causés depuis la révolution industrielle  par les activités humaines sur notre planète.2017 à 2024 ,le temps,les voyages,les rencontres et les expériences bonnes ou mauvaises ont bati les fondations de ce projet.''' )
